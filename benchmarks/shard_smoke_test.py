...
def main():
    ...
    cfg.STORAGE_CONFIG = StorageConfig(
        STORAGE_METHOD=StorageFactory.STORAGE_METHOD_MONGODB, STORAGE_SERVER="127.0.0.1", STORAGE_PORT="27117", STORAGE_MONGODB_DBNAME="sharded", STORAGE_BAND_BUCKET_SIZE=100000
    )
